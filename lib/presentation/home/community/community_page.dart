...
import '../../../data/models/pet_model.dart'; // Kept just in case, though likely not needed if using DataService for everything

import 'create_post_page.dart';
import 'post_share_service.dart';
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () =>
                            PostShareService.captureAndShare(_shareKey),
                        icon: const Icon(
                          LucideIcons.share,
                          color: Colors.white,
                        ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    // Using timeAgo from model extension or utility
                    Text(
                      post.timeAgo, // Now valid because we imported CommunityPost
